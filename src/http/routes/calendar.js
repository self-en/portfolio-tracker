...
const { d, money, toBase, ZERO, HUNDRED } = require("../../domain/money");
const S = require("../serialize");
const { asyncHandler, notFound, conflict, validation } = require("../errors");
const { z, query, body, params, idParam, dateString } = require("../validate");
...
module.exports = { router, confidenceOf, estimateGross };
